...
from ultralytics.utils import LOGGER, RANK, DEFAULT_CFG, colorstr
from ultralytics.utils.loss import BboxLoss, FocalLossV1, tversky
...
class DetectionSegmentationTrainer(BaseTrainer):
    ...
    def get_validator(self):
        ...
        return yolo.detseg.MultiValidator(
